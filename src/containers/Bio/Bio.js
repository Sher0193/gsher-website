    ...
    return (
        ...
        <div className="img-container">
            ...
            <div className="text">
                ...
                <div className="element">
                <h4>2022</h4>
                <p>Solo Show – “A Closer Look” Blyth Festival Art Gallery, Blyth, Ontario</p>
                </div>
                <div className="element">
                <h4>2015</h4>
                <p>Solo Show – “A Trick of the Light” Blyth Festival Art Gallery, Blyth, Ontario</p>
                </div>
                <div className="element">
                <h4>2010</h4>
                <p>Solo Show – “A Sense of Place” Marten Arts Gallery, Bayfield Ontario</p>
                </div>
                <div className="element">
                <h4>2002</h4>
                <p>Three Person Show, “The Selective Eye” Blyth Festival Art Gallery, Blyth, Ontario</p>
                </div>
            </div>
